    ...
    try
      ...
      try
        ...
        try
          ...
          begin
            Label4.Text := 'detect time: ' + FloatToStr((TThread.GetTickCount64 - FTickCountInference) / 1000) + ', nms time: ' + FloatToStr((TThread.GetTickCount64 - FTickCountNMS) / 1000) + ', face count: ' + IntToStr(FFaceList.Count);
  ...
  case ComboBox3.ItemIndex of
    0:
      begin
        ...
        FaceDetection.LoadModel('face_detection_160.tflite', StrToInt(ComboBox2.Items[ComboBox2.ItemIndex]));
      end;
    1:
      begin
        FaceDetectionInputSize := 192;
        FaceDetectionOutputSize := 2268;
        FaceDetection.LoadModel('face_detection_192.tflite', StrToInt(ComboBox2.Items[ComboBox2.ItemIndex]));
      end;
    2:
      begin
        FaceDetectionInputSize := 256;
        FaceDetectionOutputSize := 4032;
        FaceDetection.LoadModel('face_detection_256.tflite', StrToInt(ComboBox2.Items[ComboBox2.ItemIndex]));
      end;
    3:
      begin
        FaceDetectionInputSize := 320;
        FaceDetectionOutputSize := 6300;
        FaceDetection.LoadModel('face_detection_320.tflite', StrToInt(ComboBox2.Items[ComboBox2.ItemIndex]));
      end;
    4:
      begin
        FaceDetectionInputSize := 480;
        FaceDetectionOutputSize := 14175;
        FaceDetection.LoadModel('face_detection_480.tflite', StrToInt(ComboBox2.Items[ComboBox2.ItemIndex]));
      end;
    5:
      begin
        FaceDetectionInputSize := 640;
        FaceDetectionOutputSize := 25200;
        FaceDetection.LoadModel('face_detection_640.tflite', StrToInt(ComboBox2.Items[ComboBox2.ItemIndex]));
      end;
  end;
end;
...
{$IFDEF MSWINDOWS}
  ...
  FaceDetection.LoadModel('face_detection_640.tflite', 8);
{$ENDIF}
end;
